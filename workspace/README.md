...
| 模块 | 详细设计 |
|---|---|
| 前端 | [01-前端详细设计.md](../docs/detail-design/01-前端详细设计.md) |
| 后端 | [02-后端详细设计.md](../docs/detail-design/02-后端详细设计.md) |
| AI | [03-AI接入详细设计.md](../docs/detail-design/03-AI接入详细设计.md) |
| 数据 | [04-数据存储详细设计.md](../docs/detail-design/04-数据存储详细设计.md) |
| 部署 | [05-部署运维详细设计.md](../docs/detail-design/05-部署运维详细设计.md) |
