...
const routes: RouteRecordRaw[] = [
  { path: '/login', name: 'Login', component: () => import('@/pages/login/LoginPage.vue'), meta: { layout: 'blank', requiresAuth: false } },
  {
    ...
    children: [
      { path: 'dashboard', name: 'Dashboard', component: () => import('@/pages/dashboard/DashboardPage.vue'), meta: { title: '工作台', icon: 'home', copilot: 'chat' } },
      { path: 'tasks', name: 'Tasks', component: () => import('@/pages/tasks/TasksPage.vue'), meta: { title: '任务中心', icon: 'check', copilot: 'task' } },
      ...
      { path: 'files', name: 'Files', component: () => import('@/pages/files/FilesPage.vue'), meta: { title: '文件中心', icon: 'file', copilot: 'file' } },
      ...
      { path: 'settings', name: 'Settings', component: () => import('@/pages/settings/SettingsPage.vue'), meta: { title: '设置', icon: 'settings', copilot: 'chat' } },
    ],
  },
